...
import com.anfly.finalproject.service.AudioService;

public class AudioInServiceActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String path = Environment.getExternalStorageDirectory() + "/Pictures/我的楼兰-云朵.mp3";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_audio_in_service);
        initView();
        initListener();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_start:
                audioService.play(path, seekbar_audio);
                break;
            case R.id.btn_pause:
                audioService.pause();
                break;
